<?php
  ...
  function has_unique_menu_menu_name($menu_name, $current_id="0") {
    global $db;
  ...
  function has_unique_username($username, $current_id="0") {
    ...
    $sql = "SELECT * FROM admins "; ///////////// GANTI TABEL DB DARI ADMINS JADI USER
  ...
  function has_unique_username_user($username, $current_id="0") {
    global $db;
